...
urlpatterns = [
    ...
    path('applications/', views.applicant_applications, name='applicant_applications'),
    #  :no-index:THIS LINE IS CRUCIAL
    #  :no-index:... any other URL patterns for the applicant app
]
