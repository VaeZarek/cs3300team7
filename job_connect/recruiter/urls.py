...
app_name = 'recruiter'  # :no-index: Add this line to define the app namespace
...
urlpatterns = [
    ...
    path('dashboard/', views.recruiter_dashboard, name='recruiter_dashboard'), # :no-index: Example dashboard
